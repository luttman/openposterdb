...
pub fn admin_routes() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/api/admin/seasons", get(handlers::admin::list_seasons).delete(handlers::admin::clear_seasons))
        .route("/api/admin/seasons/{id_type}/{id_value}", delete(handlers::admin::purge_season))
